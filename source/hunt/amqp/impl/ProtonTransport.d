     ...
     // data.readBytes(buffer.getRemaining());
      ...
      do {
       ...
       // byte[] tmb = new byte[transportBuffer.position() + amount];
        logInfo("recv : %s --%d" ,data.getReadableBytes,data.getReadableBytes.length);
        data.readBytes(transportBuffer);
    ...
    synchronized(this)
    {
      ...
      while (!done) {
        ...
        if (outputBuffer !is null && outputBuffer.hasRemaining()) {
          ...
          logInfo("send : %s --- %d" , outputBuffer.getRemaining(),outputBuffer.getRemaining.length);
          socket.write(outputBuffer);
          // internal.writeMessage(bb);
          logInfo ("flushConsumed beging ...............................................");
          transport.outputConsumed();
          logInfo ("flushConsumed end ...............................................");
        } else {
          done = true;
        }
      }
