...
interface ProtonHelper {
   ...
   * @return the message
   */
  public static Message message(String bd) {
   ...
   * @return the message
   */
  public static Message message(String address, String bd) {
  ...
  public static ErrorCondition condition(String condition, String description) {
    return ProtonHelper.condition(Symbol.valueOf((cast(string)(condition.getBytes()))), description);
  }
   ...
   * @return the delivery
   */
  public static ProtonDelivery accepted(ProtonDelivery delivery, bool settle) {
   ...
   * @return the delivery
   */
  public static ProtonDelivery rejected(ProtonDelivery delivery, bool settle) {
   ...
   * @return the delivery
   */
  public static ProtonDelivery released(ProtonDelivery delivery, bool settle) {
   ...
   * @return the delivery
   */
  public static ProtonDelivery modified(ProtonDelivery delivery, bool settle, bool deliveryFailed, bool undeliverableHere) {
  ...
  //static AsyncResult!T future(V)(T value, ErrorCondition err) {
